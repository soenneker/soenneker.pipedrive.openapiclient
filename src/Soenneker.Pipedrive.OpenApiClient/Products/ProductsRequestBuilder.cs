...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public async Task<global::Soenneker.Pipedrive.OpenApiClient.Models.GetProductResponse?> PostAsync(global::Soenneker.Pipedrive.OpenApiClient.Models.AddProductRequest body, Action<RequestConfiguration<DefaultQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<global::Soenneker.Pipedrive.OpenApiClient.Models.GetProductResponse> PostAsync(global::Soenneker.Pipedrive.OpenApiClient.Models.AddProductRequest body, Action<RequestConfiguration<DefaultQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#nullable restore
        ...
        {
#endif
            var requestInfo = new RequestInformation(Method.GET, "{+baseurl}/products{?cursor*,custom_fields*,filter_id*,ids*,limit*,owner_id*,sort_by*,sort_direction*,updated_since*}", PathParameters);
